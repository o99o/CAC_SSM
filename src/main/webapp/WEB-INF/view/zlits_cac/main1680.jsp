...
<head>
  <title>公共应用组件</title>
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/cac-all-main.js"></script>
  <script type="text/javascript">
	 ...
	 */
	 function vehicleManageIcon (){
		 $('#childPage').attr('src',"${pageContext.request.contextPath}/cacInto/main1680");
	...
	function exitSystem(){
		window.location.href="${pageContext.request.contextPath}/cacInto/cacLogout.do";
		 /* $.ajax({
		        type:'GET',
		        url: "${pageContext.request.contextPath}/cacInto/cacLogout.do"
		    	}); */
		}
</script>
</head>
...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    <div class="layui-logo">停车场管理平台</div>
    <!--顶部导航栏 -->
    <ul class="layui-nav layui-layout-left menuTop">
      <li class="layui-nav-item"><a href="javascript:vehicleManageIcon();" id="vehicleManage" class="headerMenu"><img alt="" src="${pageContext.request.contextPath}/images/menu/safe_manage.png">快捷菜单1</a></li>
      <li class="layui-nav-item"><a href="javascript:systemMonitorIcon();" id="userManage" class="headerMenu"><img alt="" src="${pageContext.request.contextPath}/images/menu/safe_manage.png">快捷菜单2</a></li>
      <li class="layui-nav-item">
        <a href="javascript:otherSysIcon();" id="otherSys" class="headerMenu"><img alt="" src="${pageContext.request.contextPath}/images/menu/safe_manage.png">快捷菜单2</a>
      </li>
    </ul>
